...
const initSection: string = `init: "{
        ...
        bounce($nameLast || this_address || asset['asset'].exists || trigger.address || trigger.unit);
    }"`;
...
vm.load(initBytecode, {this_address: "THIS_ADDRESS", trigger: {unit: "TRIGGER_UNIT", initial_unit: "TRIGGER_UNIT", address: 'TRIGGER_ADDRESS', output: {base: 3000}, outputs: {base: 3000}}});
