...
], {this_address: "MY_ADDRESS", mci: 1, timestamp: Math.trunc(Date.now() / 1000), trigger: {unit: "TRIGGER_UNIT", initial_unit: "TRIGGER_UNIT", address: "TRIGGER_ADDRESS", output: {base: 3000}, outputs: {base: 3000}}});
